...
>
  <head>
    ...
    <title>View Staff | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Staff /</span> Overview</h4>
                <?php include('message.php'); ?>
                <div class="card">
                <h5 class="card-header fw-bold">Staffs Data Table
                    <a href="add-staff.php" class="btn btn-outline-primary float-end" >Add New Staff</a>
                </h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php 
                        ...
                        $query = "SELECT * FROM staffs WHERE sfdatastatus='1' ORDER BY no";
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $staff)
                            {
                                ?>
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?=$staff['sfregid']?></strong></td>
                        <td><?=$staff['sfnameini']?></td>
                        <td><?=$staff['sfcname']?></td>
                        <td><?=$staff['sfpwrk']?></td>
                        <td>
                          <a 
                          type="submit"
                          href="view-staff-dtls.php?regid=<?=$staff['sfregid']?>"
                          class="btn btn-outline-info">View Dtls & Edit</a>
                        </td>
                      </tr>
                      <?php
                            }
