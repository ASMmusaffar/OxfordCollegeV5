...
>
  <head>
    ...
    <title>CCR | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
              <h4 class="fw-bold py-3 mb-4">CCR</h4>
              <?php include('message.php'); ?>
              <div class="row">
                <div class="col-md-12">
                  <form method="POST" action="engine.php" enctype="multipart/form-data">
                  <div class="card mb-4">
                    <h5 class="card-header fw-bold">Add New Report</h5>
                    <!-- Account -->
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-3">
                          ...
                          <select id="ccrstaff" name="ccrstaff" class="select2 form-select" required>
                          ...
                          <?PHP
                            ...
                            if(mysqli_num_rows($query_run2) > 0)
                            {
                                ...
                                {
                                    ?>
                              <option value="<?=$staff['sfcname']?>"><?=$staff['sfnameini']?></option>
                              <?PHP
                                }
                            }
                            else{
                        ...
                        <div class="mb-3 col-md-3">
                          ...
                          <select id="ccrbatch" name="ccrbatch" class="select2 form-select" required>
                              <option value="CPE">Select Batch</option>
                              <?PHP
                            $query3 = "SELECT * FROM batches WHERE batdatastatus='1' AND batstatus='active'  ";
                        ...
                        <div class=" float-end">
                          ...
                          <button type="submit" name="ccr_submit" class="btn btn-primary me-2">Create CCR</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                <h5 class="card-header fw-bold">Reports
                </h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php 
                        ...
                        $query = "SELECT * FROM ccr WHERE ccrdatastatus=1 ORDER BY ccrdate DESC, no DESC ";
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $ccr)
                            {
                                ?>
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?=$ccr['ccrdate']?></strong></td>
                        <td><?=$ccr['ccrstaff']?></td>
                        <td><?=$ccr['ccrbatch']?></td>
                        <td><?=$ccr['ccrstartt']?></td>
                        <td><?=$ccr['ccrfinishedt']?></td>
                        <td><?=$ccr['ccrdesc']?></td>
                        <td>
                          <a 
                          type="submit"
                          href="engine.php?ccrdltid=<?=$ccr['no']?>"
                      ...
                      <?php
                        ...
                        echo '<tr><td colspan="7" rowspan="2" class="text-center mt-2 mb-2"> No Reports Found </td></tr>';
                        }
                        ?>
