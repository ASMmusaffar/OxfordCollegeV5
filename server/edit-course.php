...
if(!$_GET['crseditid']){
  $_SESSION['message'] = "You can't access Edit-Course page until select a course from course details table";
...
>
  <head>
    ...
    <title>Course Management | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
<?php 
                    ...
                    if(isset($_GET['crseditid'])){
                        $crseditno=$_GET['crseditid'];
                        $query = "SELECT * FROM courses WHERE crsdatastatus=1 AND no='$crseditno' ";
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header fw-bold">Edit Course</h5>
                    <!-- Account -->
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                          ...
                          <input type="text" id="crscname" name="crscname" class="form-control" value="<?=$crs['crscname']?>" required>
                        </div>
                        <div class="mb-3 col-md-12">
                          ...
                          <textarea class="form-control"
                            id="crsdesc"
                            name="crsdesc"
                            required cols="30" rows="6"><?=$crs['crsdesc']?></textarea>
                        </div>
                        <input
                            class="form-control"
                            type="hidden"
                        ...
                        <div class=" float-end">
                          ...
                          <button type="submit" name="crs_update" class="btn btn-primary me-2">Update Course</button>
                        </div>
