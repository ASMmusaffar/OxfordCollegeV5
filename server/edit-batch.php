...
if(!$_GET['bateditid']){
  $_SESSION['message'] = "You can't access Edit-Batch page until select a batch from batch details table";
...
>
  <head>
    ...
    <title>Edit Batch | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
<?php 
                    ...
                    if(isset($_GET['bateditid'])){
                        $bateditno=$_GET['bateditid'];
                        $query = "SELECT * FROM batches WHERE batdatastatus='1' AND no='$bateditno' ";
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            ...
                            {
                                ?>
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Batch / </span>Edit Batch</h4>
              <?php include('message.php'); ?>
              <div class="row">
                <div class="col-md-12">
                  <form method="POST" action="engine.php" enctype="multipart/form-data">
                  <div class="card mb-4">
                    <h5 class="card-header fw-bold">Edit Batch</h5>
                    <!-- Account -->
                    <div class="card-body">
                      <div class="row">
                        <div class="mb-3 col-md-4">
                          <label class="form-label">Course Code</label>
                            <span
                              ...
                              data-bs-html="true"
                              title="<span>You can't change Course Code</span>"
                            >
                            <i class='bx bx-error-circle' ></i>
                            </span>
                          <input type="text" id="crscname" name="crscname" class="form-control" value="<?=$bat['crscname']?>" readonly required>
                        </div>
                        <div class="mb-3 col-md-4">
                        ...
                        <div class="mb-3 col-md-4">
                          ...
                          <input type="number" id="batno" name="batno" class="form-control" value="<?=$bat['batno']?>" required>
                        </div>
                        <div class="mb-3 col-md-4">
                        ...
                        <label class="form-label">Status</label>
                          <select name="batstatus" id="batstatus" required class="select2 form-select">
                              <option value="active"
                                <?PHP
                                  if($bat['batstatus']=='active'){
                                    echo 'selected';
                                  }
                                ?>>active
                              </option>
                        ...
                        <span
                              ...
                              data-bs-placement="right"
                              data-bs-html="true"
                              title="<span>If batch status still active, don't make change at this field.</span>"
                            >
                            <i class='bx bx-error-circle' ></i>
                            </span>
                          <input
                        ...
                        <div class=" float-end">
                          ...
                          <button type="submit" name="bat_update" class="btn btn-primary me-2">Update Course</button>
                        </div>
