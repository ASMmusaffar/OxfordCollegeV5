...
>
  <head>
    ...
    <title>View Staff Details | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Staff / Overview /</span> Details</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-4">
                            ...
                            <input disabled required class="form-control text-uppercase" type="text" name="sffullname" id="sffullname" placeholder="ABDUL SAMADU MOHAMMED MUSAFFAR" value="<?=$staffs['sffullname']?>" />
                          </div>
                          <div class="mb-3 col-md-4">
                            <label for="lastName" class="form-label">Name With Initial</label>
                            <input disabled required class="form-control text-uppercase" type="text" name="sfnameini" id="sfnameini" placeholder="ASM. MUSAFFAR" value="<?=$staffs['sfnameini']?>" />
                          </div>
                          <div class="mb-3 col-md-4">
                            <label for="lastName" class="form-label">Education Title</label>
                            <input disabled class="form-control text-uppercase" type="text" name="sfedutit" id="sfedutit" placeholder="BSc IT" value="<?=$staffs['sfedutit']?>" />
                          </div>
                          ...
                          <div class="mb-3 col-md-3">
                            <label class="form-label" for="phoneNumber">Working Position (P)</label>
                          ...
                          <div class="mb-3 col-md-3">
                            <label class="form-label" for="phoneNumber">Working Position (S)</label>
                            <div class="input-group input-group-merge">
                              <input 
                              disabled
                                type="text"
                          ...
                          <div class="mb-3 col-md-3">
                            ...
                            <select id="language" name="sfgen" class="select2 form-select" required disabled>
                              <option value="M"
                                <?PHP
                                  if($staffs['sfgen']=='M'){
                                    echo 'selected';
                          ...
                          <div class="mb-3 col-md-9">
                            ...
                            <input disabled required type="text" class="form-control" id="sfadd" name="sfadd" value="<?=$staffs['sfadd']?>" placeholder="Hijra, 3rd Road, Sammanthurai" />
                          </div>
                          <div class="mb-3 col-md-3">
                            <label for="state" class="form-label">Date Of Birth</label>
                            <input disabled class="form-control" type="date" id="sfdob" name="sfdob" value="<?=$staffs['sfdob']?>"  required/>
                          </div>
                          <div class="mb-3 col-md-3">
                          ...
                          <div class="mb-3 col-md-3">
                            ...
                            <select id="sflang" name="sflang" class="select2 form-select" required disabled>
                        ...
                        <div class="mt-4 float-end">
                          <a type="button" href="edit-staff.php?regid=<?=$staffs['sfregid']?>" class="btn btn-warning me-2">Edit Staff Data</a>
                        </div>
...
<h6 class=" text-center fw-bold">Select the staff from view staff page</h6>
</center>
<?PHP 
}
?>
