...
>
  <head>
    ...
    <title>Add New Course | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Course /</span> Add New Course</h4>
              <?php include('message.php'); ?>
              <div class="row">
                <div class="col-md-12">
                  <form method="POST" action="engine.php" enctype="multipart/form-data">
                  <div class="card mb-4">
                    <h5 class="card-header fw-bold">Add New Course</h5>
                    <!-- Account -->
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                          ...
                          <input type="text" id="crscname" name="crscname" class="form-control" required>
                        </div>
                        <div class="mb-3 col-md-12">
                          ...
                          <textarea class="form-control"
                            id="crsdesc"
                            name="crsdesc"
                            placeholder="You can describe about this course here"
                        ...
                        <div class=" float-end">
                          ...
                          <button type="submit" name="crs_submit" class="btn btn-primary me-2">Create Course</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                <h5 class="card-header fw-bold">Courses Details
                </h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php 
                        ...
                        $query = "SELECT * FROM courses WHERE crsdatastatus=1 ORDER BY no DESC ";
                        $query_run = mysqli_query($con, $query);
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $crs)
                            {
                                ?>
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?=$crs['crsstart']?></strong></td>
                        <td><?=$crs['crsname']?></td>
                        <td><?=$crs['crscname']?></td>
                        <td><?=$crs['crsdesc']?></td>
                        <td><?=$crs['crsstatus']?></td>
                        <td>
                          <a 
                          type="submit"
                          href="edit-course.php?crseditid=<?=$crs['no']?>"
