...
>
  <head>
    ...
    <title>Edit Student | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Batch /</span> Edit Student</h4>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="mb-3 col-md-3">
                          ...
                          <?PHP
                            $query2 = "SELECT DISTINCT batfcname FROM students WHERE stdatastatus='1' AND ststatus='active' AND batfcname!='' ORDER BY no ";
                  ...
                  <table class="table">
                    ...
                    <?php 
                        ...
                        if(isset($_POST['batfcname1'])){
                          ...
                          $query = "SELECT * FROM students WHERE stdatastatus='1' AND batfcname='$batfcname1' AND ststatus='active' ORDER BY no DESC ";
                        }
                        else{
                          $query = "SELECT * FROM students WHERE stdatastatus='1' AND ststatus='active' ORDER BY no DESC ";
                        }
                      ...
                      <?php
                        ...
                        echo '<tr><td colspan="7" rowspan="2" class="text-center mt-2 mb-2"> No Students Found </td></tr>';
                        }
                        ?>
