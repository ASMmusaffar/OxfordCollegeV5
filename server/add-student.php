...
>
  <head>
    ...
    <title>New Student | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Student /</span> New Student</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="upload/stnd-img/unknown.jpeg"
                          alt="user-avatar"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 col-md-4">
                          ...
                          <select id="batfcname" name="batfcname" class="select2 form-select" required>
                              <option value="">Select Course & Batch</option>
                              <?PHP
                            $query3 = "SELECT * FROM batches WHERE batdatastatus='1' AND batstatus='active' ORDER BY batfcname DESC ";
                          ...
                          <div class="mb-3 col-md-9">
                            ...
                            <input required type="text" class="form-control" id="stattr" name="stattr" placeholder="Hijra, 3rd Road, Sammanthurai" />
                          </div>
                          <div class="mb-3 col-md-3">
                            <label for="state" class="form-label">Date Of Birth</label>
                            <input class="form-control" type="date" id="stdob" name="stdob"  required/>
                          </div>
                          <div class="mb-3 col-md-4">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-4">
                            ...
                            <input  type="text" class="form-control" id="stedugrade" name="stedugrade" />
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-4">
                            ...
                            <select id="strole" name="strole" class="select2 form-select" required>
                              ...
                              <option value="vice-coordinator">Vice Coordinator</option>
                            </select>
                          </div>
                          ...
                          <input
                            ...
                            <button type="submit" name="student_submit" class="btn btn-primary me-2">Create Student Data</button>
                        </div>
                        </div>
                      </div>
                    </div>
