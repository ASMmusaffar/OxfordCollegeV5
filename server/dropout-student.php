...
>
  <head>
    ...
    <title>Drop Out | OXFORD COLLEGE V4 | Code by Musaffar Industries</title>
...
?>
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Student /</span> New DropOut</h4>
              <?php include('message.php'); ?>
              <div class="row">
                <div class="col-md-12">
                  <form method="POST" action="engine.php" enctype="multipart/form-data" id="formAccountDeactivation">
                  <div class="card mb-4">
                    <h5 class="card-header fw-bold">Add New Drop Out</h5>
                    <!-- Account -->
                    <div class="card-body">
<?PHP
if(isset($_POST['stdrp'])){
?>
                      <div class="row">
                        <div class="mb-3 col-md-4">
                          <label class="form-label">Reg No</label>
                          <input type="text" id="stregno" name="stregno" value="<?=$_POST['stregno']?>" class="form-control" readonly>
                        </div>
                        <div class="mb-3 col-md-4">
                        ...
                        <div class="mb-3 col-md-4">
                          <label class="form-label">Dropped Out Date</label>
                          <input
                            class="form-control"
                            type="date"
                            id="stdrpdate"
                        ...
                        <div class="mb-3 col-md-12">
                          <label class="form-label">DropOut Reason</label>
                        ...
                        <div class="mb-3 col-12">
                          <div class="alert alert-danger">
                            <h6 class="alert-heading fw-bold mb-1">Are you sure you want to dropout this student?</h6>
                            <p class="mb-0">Once you dropout, there is no going back. Please be certain.</p>
                        ...
                        <div class="col-12 mb-3">
                          ...
                          <input
                            ...
                            value="<?=$_POST['no']?>"
                          />
                          <label class="form-check-label" for="accountActivation">I understood about this process</label>
                        </div>
                        <div class=" float-end">
                          <button type="submit" name="stdrpdata" class="btn btn-danger deactivate-account">DropOut</button>
                        </div>
                      </div>
<?PHP
}
...
<h6 class=" text-center fw-bold">Select the Student from edit student page</h6>
</center>
<?PHP
}
?>
